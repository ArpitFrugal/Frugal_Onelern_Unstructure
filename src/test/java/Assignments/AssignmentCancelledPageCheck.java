...
public class AssignmentCancelledPageCheck extends Base {
    ...
    @Description("Examine whether or noti the teacher can successfully view the assignments in drafts page.")
    @Story("ASGFT_07")
