...
public class AnalyticsLearningOutcomesCheck extends Base {
    ...
    @Description("Examine whether or noti the teacher should be able to open the learning outcomes successfully.")
    @Story("ANAFT_04")
