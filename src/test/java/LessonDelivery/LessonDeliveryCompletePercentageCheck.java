...
public class LessonDeliveryCompletePercentageCheck extends Base {
...
//        ValidateTest(completed_plans/Total_no_of_plans);
    }

    public void ValidateTest(int CalculatedPercentage) {
